...
const useStyles = makeStyles(theme => ({
  ...
  card: {
    ...
    boxShadow: "none",
    position: "relative",
    color: course => (course.type ? "black" : "black"),
    backgroundColor: course => (course.type ? "#ffffff" : "#ffffff")
  },
  title: {
    fontSize: 14,
    fontWeight: "bold"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      { course.topic ? (
                        <p style={ { color: "#242424" } }>Topic: { course.topic }</p>
                      ) : null }
                      { course.type ? (
                        <p style={ { color: "#242424" } }>{ course.type }</p>
                      ) : null }
                    </div>
                  </div>
                </div>
